...
export const ORGANS = [
  ...
  { id: 'gut',      name: 'Intestinal wall', short: 'GUT',     map: null, mx: 0.51, my: 0.505, depth: 3, pressure: 1.05, hue: 44, vessel: 'mesenteric arcade',
    note: 'Crowded, damp, litigious. Mind the resident flora.' },
  { id: 'spleen',   name: 'Splenic sinus',   short: 'SPLEEN',  map: null, mx: 0.60, my: 0.405, depth: 4, pressure: 1.15, hue: 300, vessel: 'splenic sinus',
    note: 'The client will not miss it. Try anyway.' },
  { id: 'liver',    name: 'Hepatic portal',  short: 'LIVER',   map: null, mx: 0.42, my: 0.395, depth: 4, pressure: 1.25, hue: 18,  vessel: 'hepatic portal',
    note: 'Slow, dense, forgiving of mistakes. Not of invoices.' },
  { id: 'kidney',   name: 'Renal capillary', short: 'KIDNEY',  map: null, mx: 0.58, my: 0.455, depth: 5, pressure: 1.45, hue: 350, vessel: 'renal capillary',
  ...
  { id: 'brain',    name: 'Carotid branch',  short: 'BRAIN',   map: null, mx: 0.50, my: 0.085, depth: 6, pressure: 2.25, hue: 275, vessel: 'carotid branch',
